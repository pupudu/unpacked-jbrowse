...
# 7.14 (Revision: 71400) from the contents of
...
MAKEMAKER   = /var/www/html/jbrowse/extlib/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 7.14
MM_REVISION = 71400
...
realclean ::
	$(RM_F) \
	  ...
	  $(INST_SCRIPT)/bam-to-json.pl $(INST_SCRIPT)/biodb-to-json.pl \
	  $(INST_SCRIPT)/draw-basepair-track.pl $(INST_SCRIPT)/flatfile-to-json.pl \
	  $(INST_SCRIPT)/generate-names.pl $(INST_SCRIPT)/json2conf.pl \
	  $(INST_SCRIPT)/maker2jbrowse $(INST_SCRIPT)/new-plugin.pl \
	  $(INST_SCRIPT)/prepare-refseqs.pl $(INST_SCRIPT)/remove-track.pl \
	  $(INST_SCRIPT)/ucsc-to-json.pl $(INST_SCRIPT)/wig-to-json.pl 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'generated_by: '\''ExtUtils::MakeMaker version 7.14, CPAN::Meta::Converter version 2.143240'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "generated_by" : "ExtUtils::MakeMaker version 7.14, CPAN::Meta::Converter version 2.143240",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="x86_64-linux-gnu-thread-multi-5.18" />' >> JBrowse.ppd
